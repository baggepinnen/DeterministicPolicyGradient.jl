...
function critic_update_gradient!(w,v,T,αw,αv,dw,dv,dws,dvs,opts)
    Δw = αw/T * dw
    Δv = αv/T * dv
...
function reduce_stepsize_periodic!(i,αΘ,αw,αv,opts)
...
function reduce_stepsize_divergence!(αΘ,αw,αv,Θb,wb,vb)
